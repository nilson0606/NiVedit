...
(async()=>{
 ...
 // v11.9：下軌那一組排在上面，整條時間軸的 L 編號才由上往下遞增（L1,L1,L2,L2,L3…）。
 ...
 // v11.9：時間軸高度自動貼合內容，L1~L5 加音軌不用捲就看得完；捲軸本身保留。
 ...
 // ── v11.9：字幕自由定位（x＝字幕框水平中心、y＝字幕框底緣，整軌共用）──
 ...
 // ── v11.9：字幕綁著某一段影片，那一段搬到哪就跟到哪（時間＋軌道）──
