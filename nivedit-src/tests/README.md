...
十六支計數式測試共 694 項（含終點對位 90 項、motion 67 項、字幕 56 項、圖層 51 項、旋轉／儲存 68 項、雙軌 45 項）；另有 GIF 斷言式專項，以及兩支 i18n 診斷腳本。
...
| `subtitle-scope.e2e.cjs` | 空白上軌新增、上下軌列表及批次隔離、原生／備援 SRT、清空與復原、移軌、時間軸選取跟隨、存讀與翻譯、「＋ 字幕」兩選一 | 38 |
