...
十六支計數式測試共 709 項（含終點對位 90 項、motion 67 項、字幕 56 項、圖層 51 項、旋轉／儲存 71 項、雙軌 45 項）；另有 GIF 斷言式專項，以及兩支 i18n 診斷腳本。
...
| `clip-options.e2e.cjs` | 每段內扣／外加、獨立淡化、即時更新、換軌／復原／分割、遷移／存讀、MP4 及原聲／配樂頻率分量、雙軌字幕連動亮度、裁切「現在／歸零／到底」 | 55 |
